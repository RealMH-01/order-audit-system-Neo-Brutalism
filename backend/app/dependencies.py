...
from app.db.supabase_client import ApiKeyCipher, get_api_key_cipher
...
def get_auth_service(
    ...
    return AuthService(settings=settings, store=store)
...
def get_rules_config_service(
    ...
    return RulesConfigService(settings=settings, store=store)
...
def get_settings_service(
    ...
    return SettingsService(settings=settings, store=store, cipher=cipher)
